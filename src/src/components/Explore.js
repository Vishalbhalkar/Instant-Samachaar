...
const Explore = () => {
  return (
    <div>
      <section className="bg-black bg-cover bg-center w-full h-full bg-no-repeat relative min-h-[530px]" style={{ backgroundImage: `url(${CTABg})` }}>
        <div className='flex justify-center items-center relative'>
            <div className='absolute w-5/6 border-[1.5px] border-white rounded-lg'></div>
        </div>

        <div className="w-11/12 max-w-[1080px] relative flex flex-row items-center justify-between space-x-20 mx-auto pt-16">
          <div className="flex flex-col gap-5 mt-12 max-w-[600px]">
            ...
            <div className="w-6 h-1 bg-bluet"></div>
            ...
            <ul className="flex flex-row flex-wrap gap-x-12 text-white gap-y-3">
              <li className=" text-white flex flex-row gap-2">
            ...
            <button className="min-w-[32px]  text-sm font-bold bg-white text-bluet border flex rounded-sm items-center hover:text-blue-400 transition-all duration-200 py-3 px-4 place-self-start">
              Sign Up
